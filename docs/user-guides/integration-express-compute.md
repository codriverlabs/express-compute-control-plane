...
# With options
ecp create-cluster acme-staging --arch arm64 --pricing spot --wait
...
| | k3s | Express Compute |
|---|---|---|
| Cluster registration | Manual (`ecp create-cluster <name> --kubeconfig <path>`) | Automatic (first-boot script) |
